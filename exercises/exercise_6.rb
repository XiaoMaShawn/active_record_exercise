...
@store1.employees.create(first_name: "Leo", last_name: "Jaz", hourly_rate: 60)
@store2.employees.create(first_name: "Jason", last_name: "Wang", hourly_rate: 34)
@store2.employees.create(first_name: "Tim", last_name: "Le", hourly_rate: 34)
